...
public class Frame extends javax.swing.JFrame {
    ...
    public void mostraMessaggio(String messaggio) {
        JOptionPane.showMessageDialog(this, messaggio, "Company details", JOptionPane.INFORMATION_MESSAGE);
    }

    public void mostraMessaggioErrore(String errore) {
        JOptionPane.showMessageDialog(this, errore, "Company details - Errore", JOptionPane.ERROR_MESSAGE);
    }
