...
public class DAOArchivioMock implements IDAOArchivio {
    ...
    public Archivio carica(String nomeFile) throws DAOException {
        ...
        Aula aula2 = new Aula("AU2", "Aula Peroni", 0);
